...
phpunit: ## execute project unit tests
		docker-compose exec php sh -lc "php bin/phpunit $(conf)"
...
db: ## recreate database
		docker-compose exec php sh -lc 'php ./bin/console d:d:d --force --if-exists'
		docker-compose exec php sh -lc 'php ./bin/console d:d:d --force --if-exists --env=test'
		docker-compose exec php sh -lc 'php ./bin/console d:d:c'
		docker-compose exec php sh -lc 'php ./bin/console d:d:c --env=test'
		docker-compose exec php sh -lc 'php ./bin/console d:m:m -n'
		docker-compose exec php sh -lc 'php ./bin/console d:m:m -n --env=test'
